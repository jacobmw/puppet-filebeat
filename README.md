...
**Parameters for `filebeat::input`**
  ...
  - `fingerprint_length`: [Integer] When using the `filestream` input, sets `prospector.scanner.fingerprint.length` to control how many bytes are used for file fingerprinting (default: undef)
